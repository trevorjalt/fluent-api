      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          words: [
            ...
            { original: 'kommunizieren', translation: 'communicate' },
            { original: 'auf wiedersehen', translation: 'goodbye' },
            { original: 'lebensmittel', translation: 'food' },
            { original: 'junge', translation: 'boy' },
            { original: 'mädchen', translation: 'girl' },
            { original: 'mann', translation: 'man' },
            { original: 'frau', translation: 'woman' },
            { original: 'technologie', translation: 'technology' },
            { original: 'ingenieur', translation: 'engineer' },
            { original: 'lernen', translation: 'learn' },
            { original: 'liebe', translation: 'love' },
            { original: 'tag', translation: 'day' },
            { original: 'nacht-', translation: 'night' },
          ]
        }
        return supertest(app)
          .post('/api/user')
